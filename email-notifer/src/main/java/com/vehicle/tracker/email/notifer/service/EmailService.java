	...
	public void sendEmailNotification(String email, List<String> list) throws AddressException, MessagingException {
		...
		Session session = Session.getInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("biswa90.work@gmail.com", "Conti@7789");
			}
		});
		MimeMessage msg = new MimeMessage(session);
		msg.setFrom(new InternetAddress(email, false));

		msg.setRecipients(MimeMessage.RecipientType.TO, InternetAddress.parse("biswa90.work@gmail.com"));
