...
public class VehicleViolationTrackerController {
	...
	org.apache.logging.log4j.Logger log = LogManager.getLogger(VehicleViolationTrackerController.class);
	...
	public VehiclesPenaltyResponse findAllVehicleDetails(@RequestParam("email") String email,
		...
		log.info("started :: VehicleViolationTrackerController-> fetchVehicleInfos :: with vehicle id:"+vehicleNumbers.toString());
		...
		log.info("response came as ::  VehicleViolationTrackerController-> fetchVehicleInfos :: with vehicle id:"+vehicleDetailList.get(0).getVehicleNumber());
